    ...
    try:
        ...
        try:
            prompt = (
                ...
                # "Если вдруг вопрос пользователя не относится к банковской теме(СРАВНИ ОТВЕТЫ И ВОПРОСЫ, КАТЕГОРИИ И ПОДКАТЕГОРИИ, ВОЗМОЖНО ЭТО НАЗВАНИЯ ОСОБЫХ СЕРВИСОВ), то ответь в точности - 'Уточните вопрос'"
            )
            question = (
