  ...
  return (
    <div className="flex gap-2 p-4 border-t border-gray-200 items-end">
      ...
      <Textarea
        ...
        disabled={disabled}
        className="flex-1 min-h-[40px] max-h-[80px] resize-none bg-gray-700 border border-gray-600 text-black placeholder-gray-400 focus:ring-gray-500 rounded-lg"
        rows={1}
      />
      <Button
        onClick={handleSend}
        ...
        size="sm"
        className="w-[40px] h-[40px] p-0 bg-gray-100 text-black hover:bg-gray-200 disabled:bg-gray-600 disabled:text-gray-400 disabled:cursor-not-allowed rounded-lg flex-shrink-0"
      >
